...
if (isset($_POST['student_email'])) {
    ...
    if ($row > 0) {
        ...
        if ($method == 'POST') {
            ...
            $img_folder = '../images/students_images/' . $students_img;
            ...
            if (isset($_POST['student_name']) && isset($_POST['student_email']) && isset($_POST['student_phone']) && isset($_POST['student_password'])) {
                ...
                if ($student_Password === $student_RePassword) {
                    ...
                    $sql = "INSERT INTO `students` (`student_name`, `student_email`, `student_phone`, `student_password`, `student_image`, `student_professions`) VALUES ('$student_Name', '$student_Email', '$student_Phone', '$password_hash','$img_folder', '$student_designation')";
            ...
            <strong>Unable to Register Students !!</strong>.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>';
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    <h3 class="text-center text-uppercase text-decoration-underline">Add New Student</h3>
